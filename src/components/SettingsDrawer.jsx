...
const SettingsDrawer = ({ isOpen, onClose, onLeaveGroup, onShowHelp, user }) => {
            ...
            <div style={{
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-6">
                    ...
                    <div className="flex flex-col items-center text-center p-6 rounded-3xl" style={{background: 'rgba(255,255,255,0.15)', border: '1px solid rgba(255,255,255,0.3)'}}>
                        ...
                        <h3 className="mt-4 text-xl font-black text-white tracking-tight leading-none drop-shadow">{user?.displayName || user?.email?.split('@')[0] || 'Ankit Kumar'}</h3>
                ...
                <div className="p-6 space-y-3" style={{borderTop: '1px solid rgba(255,255,255,0.2)', background: 'rgba(255,255,255,0.08)'}}>
                    ...
                    <p className="text-[9px] text-center text-white/40 font-bold uppercase tracking-[0.3em] mt-4">FairSplit Premium V7.0.0</p>
                </div>
            </div>
        </div>
    );
